...
@implementation LZServiceTableViewHeader
...
- (void)layoutTextFieldSubviews
{
    ...
    _textFieldSearchIcon.center = CGPointMake(_textFieldPlaceholderLabel. x - _textFieldSearchIcon. width * 0.5,  _textFieldPlaceholderLabel.center.y);
}
...
- (void)textFieldDidBeginEditing:(UITextField *)textField
{
    ...
    CGFloat deltaX = _textFieldSearchIcon. x - 5;
